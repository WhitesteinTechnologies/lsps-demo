...
import com.whitestein.lsps.vaadin.ui.UIComponentFactoryV7Impl;
...
public class LspsUIComponentFactoryV7 extends UIComponentFactoryImpl {
	...
	@Override
	protected UIComponentFactoryV7Impl createV7Factory(LspsAppConnector connector) {
		return new UIComponentFactoryV7Impl(connector) {
